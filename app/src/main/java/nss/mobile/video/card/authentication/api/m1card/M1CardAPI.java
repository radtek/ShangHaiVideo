package nss.mobile.video.card.authentication.api.m1card;
...
public class M1CardAPI {
    ...
    private static final String TAG = "M1CardAPI";
    ...
    private void sendCommand(byte[] command) {
        ...
        Log.e(TAG, "----command----" + DataUtils.bytesToHexString(command));
    }
     ...
     * @param data 32位长度
     */
    private static String calibrationData(String data) {
        if (data.length() != 32) {
            return data;
        }
